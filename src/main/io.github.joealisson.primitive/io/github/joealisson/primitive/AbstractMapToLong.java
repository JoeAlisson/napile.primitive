 ...
 * @since 1.0.0
 */
public abstract class AbstractMapToLong<K> implements MapToLong<K> {

    /**
     * Sole constructor.  (For invocation by subclass constructors, typically
     * implicit.)
     */
    protected AbstractMapToLong() {
    }
    ...
    /**
     * {@inheritDoc}
     * <p>This implementation returns a set that subclasses {@link io.github.joealisson.primitive.sets.abstracts.AbstractIntSet}.
        ...
        if (keySet == null) {
            keySet = new AbstractSet<>() {
                public Iterator<K> iterator() {
                    return new Iterator<>() {
                        private final Iterator<Entry<K>> i = entrySet().iterator();
                ...
                public int size() {
                    return AbstractMapToLong.this.size();
                }

                public boolean contains(Object k) {
                    return AbstractMapToLong.this.containsKey(k);
                }
            };
        }
        return keySet;
        ...
        if (values == null) {
            values = new AbstractLongCollection() {
                ...
                public boolean contains(long v) {
                    return AbstractMapToLong.this.containsValue(v);
                }
            };
        }
        return values;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MapToLong)) {
            return false;
        }
        MapToLong<K> m = (MapToLong) o;
        if (m.size() != size()) {
            return false;
        }
    ...
    public int hashCode() {
        int h = 0;
        for (Entry<K> intLongPair : entrySet())
    ...
    protected Object clone() throws CloneNotSupportedException {
        io.github.joealisson.primitive.AbstractIntLongMap result = (io.github.joealisson.primitive.AbstractIntLongMap) super.clone();
        result.keySet = null;
        result.values = null;
        return result;
    }
