 ...
 * {@link #add(int, double) add(int, E)} and {@link #remove(double)} methods.
 *
...
public abstract class AbstractDoubleList extends AbstractDoubleCollection implements DoubleList {
     ...
     * @throws IndexOutOfBoundsException     {@inheritDoc}
     */
    public double removeFromIndex(int index) {
        throw new UnsupportedOperationException();
    }
    ...
    private class Itr implements PrimitiveIterator.OfDouble {
        /**
    ...
    private class ListItr extends Itr implements DoubleListIterator {
        ListItr(int index) {
            cursor = index;
        }
    ...
    public boolean equals(Object o) {
        ...
        DoubleListIterator e2 = ((DoubleList) o).listIterator();
    ...
    public int hashCode() {
        ...
        var it = iterator();
        while (it.hasNext()) {
            hashCode = 31 * hashCode + Double.hashCode(it.nextDouble());
        }
        return hashCode;
    }
     ...
     */
    static final class RandomAccessSpliterator implements Spliterator.OfDouble {
        ...
        RandomAccessSpliterator(DoubleList list) {
        ...
        private static double get(DoubleList list, int i) {
            try {
                return list.get(i);
            } catch (IndexOutOfBoundsException ex) {
                throw new ConcurrentModificationException();
    ...
    private static class SubIntList extends AbstractDoubleList {
         ...
         */
        public SubIntList(AbstractDoubleList root, int fromIndex, int toIndex) {
            this.root = root;
            this.parent = null;
        ...
        public double removeFromIndex(int index) {
            Objects.checkIndex(index, size);
            checkForComodification();
            double result = root.removeFromIndex(offset + index);
            updateSizeAndModCount(-1);
            return result;
        }
    ...
    private static class RandomAccessSubIntList
         ...
         */
        RandomAccessSubIntList(AbstractDoubleList root,
