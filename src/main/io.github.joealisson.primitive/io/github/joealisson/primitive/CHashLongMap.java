 ...
 */
public class CHashLongMap<V> extends AbstractLongMap<V>
     ...
     */
    public CHashLongMap(int initialCapacity) {
     ...
     * @param m the map
     */
    public CHashLongMap(LongMap<? extends V> m) {
     ...
     * @since 1.6
     */
    public CHashLongMap(int initialCapacity, float loadFactor) {
    ...
    public static  KeySetView<Boolean> newKeySet() {
        return new KeySetView<Boolean>
                (new CHashLongMap<Boolean>(), Boolean.TRUE);
    }
    ...
    public static KeySetView<Boolean> newKeySet(int initialCapacity) {
        return new KeySetView<Boolean>
                (new CHashLongMap<Boolean>(initialCapacity), Boolean.TRUE);
    }
    ...
    static final class MapEntry<V> implements Entry<V> {
        ...
        V val;       // non-null
        final CHashLongMap<V> map;
        MapEntry(long key, V val, CHashLongMap<V> map) {
            this.key = key;
            this.val = val;
            this.map = map;
        }
    ...
    static final class EntrySpliterator<V> extends Traverser<V>
        ...
        final CHashLongMap<V> map; // To export MapEntry
        long est;               // size estimate
        EntrySpliterator(Node<V>[] tab, int size, int index, int limit,
                         long est, CHashLongMap<V> map) {
            super(tab, size, index, limit);
            this.map = map;
            this.est = est;
        }
    ...
    abstract static class CollectionView<V,E>
        ...
        final CHashLongMap<V> map;
        CollectionView(CHashLongMap<V> map)  { this.map = map; }
         ...
         */
        public CHashLongMap<V> getMap() { return map; }
    ...
    public static class KeySetView<V>
        ...
        final CHashLongMap<V> map;
        KeySetView(CHashLongMap<V> map, V value) {  // non-public
            this.map = map;
            this.value = value;
        }
    ...
    static final class ValuesView<V> extends CollectionView<V,V>
        ...
        private static final long serialVersionUID = 2249069246763182397L;
        ValuesView(CHashLongMap<V> map) { super(map); }
    ...
    static final class EntrySetView<V> extends CollectionView<V, Entry<V>>
        ...
        private static final long serialVersionUID = 2249069246763182397L;
        EntrySetView(CHashLongMap<V> map) { super(map); }
