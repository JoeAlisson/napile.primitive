 ...
 *
 * <p>A special {@link #LinkedHashMapToLong()}  constructor} is
 ...
 * backing map.
 *
 * <p>The {@link #removeEldestEntry(MapToLong.Entry)} method may be overridden to
 ...
 * @since   1.4
 */
public class LinkedHashMapToLong<K> extends HashMapToLong<K> implements MapToLong<K> {
        /*
         ...
         */
        static class Entry<K> extends HashMapToLong.Node<K> {
            Entry<K> before, after;
            Entry(int hash, K key, long value, HashMapToLong.Node<K> next) {
         ...
         */
        transient Entry<K> head;

        /**
         * The tail (youngest) of the doubly linked list.
         */
        transient Entry<K> tail;
        ...
        private void linkNodeLast(Entry<K> p) {
            Entry<K> last = tail;
            tail = p;
            if (last == null)
                head = p;
        ...
        private void transferLinks(Entry<K> src,
                                   Entry<K> dst) {
            Entry<K> b = dst.before = src.before;
            Entry<K> a = dst.after = src.after;
            if (b == null)
                head = dst;
            else
                b.after = dst;
        ...
        Node<K> newNode(int hash, K key, long value, Node<K> e) {
            Entry<K> p =
        ...
        TreeNode<K> newTreeNode(int hash, K key, long value, Node<K> next) {
            TreeNode<K> p = new TreeNode<>(hash, key, value, next);
            linkNodeLast(p);
            return p;
        }
        ...
        TreeNode<K> replacementTreeNode(Node<K> p, Node<K> next) {
            Entry<K> q = (Entry<K>)p;
            TreeNode<K> t = new TreeNode<>(q.hash, q.key, q.value, next);
            transferLinks(q, t);
            return t;
        }
        ...
        void afterNodeRemoval(Node<K> e) { // unlink
            Entry<K> p =
                    (Entry<K>)e, b = p.before, a = p.after;
        ...
        void afterNodeInsertion(boolean evict) { // possibly remove eldest
            ...
            if (evict && (first = head) != null && removeEldestEntry(first)) {
                K key = first.key;
                removeNode(hash(key), key, Constants.DEFAULT_LONG_VALUE, false, true);
            }
        }
        ...
        void internalWriteEntries(java.io.ObjectOutputStream s) throws IOException {
            for (Entry<K> e = head; e != null; e = e.after) {
                s.writeObject(e.key);
         ...
         */
        public LinkedHashMapToLong(int initialCapacity, float loadFactor) {
         ...
         * @throws IllegalArgumentException if the initial capacity is negative
         */
        public LinkedHashMapToLong(int initialCapacity) {
         ...
         */
        public LinkedHashMapToLong(MapToLong<? extends K> m) {
            super();
            accessOrder = false;
         ...
         */
        protected boolean removeEldestEntry(MapToLong.Entry<K> eldest) {
            return false;
        }
        ...
        @Override
        final long[] valuesToArray(long[] a) {
            int idx = 0;
            for (Entry<K> e = head; e != null; e = e.after) {
                a[idx++] = e.value;
            }
        ...
        final class LinkedKeySet extends AbstractSet<K> {
            ...
            public final void clear()               { LinkedHashMapToLong.this.clear(); }
        ...
        final class LinkedValues extends AbstractLongCollection {
            public final int size()                 { return size; }
            public final void clear()               { LinkedHashMapToLong.this.clear(); }
            public final PrimitiveIterator.OfLong iterator() {
                return new LinkedValueIterator();
            }
            public final boolean contains(long o) { return containsValue(o); }
        ...
        public Set<MapToLong.Entry<K>> entrySet() {
            Set<MapToLong.Entry<K>> es;
            return (es = entrySet) == null ? (entrySet = new LinkedEntrySet()) : es;
        }

        final class LinkedEntrySet extends AbstractSet<MapToLong.Entry<K>> {
            public final int size()                 { return size; }
            public final void clear()               { LinkedHashMapToLong.this.clear(); }
            public final Iterator<MapToLong.Entry<K>> iterator() {
            ...
            public final Spliterator<MapToLong.Entry<K>> spliterator() {
                return Spliterators.spliterator(this, Spliterator.SIZED |
                        Spliterator.ORDERED |
                        Spliterator.DISTINCT);
            }
            public final void forEach(Consumer<? super MapToLong.Entry<K>> action) {
                if (action == null)
                    throw new NullPointerException();
                int mc = modCount;
                for (Entry<K> e = head; e != null; e = e.after)
        ...
        final class LinkedEntryIterator extends LinkedHashIterator
            ...
            public final MapToLong.Entry<K> next() { return nextNode(); }
        }
