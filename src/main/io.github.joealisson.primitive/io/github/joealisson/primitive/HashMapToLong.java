 ...
 * @since 1.2
 */
public class HashMapToLong<K> extends AbstractMapToLong<K> implements MapToLong<K>, Cloneable, Serializable {
     ...
     */
    static class Node<K> implements MapToLong.Entry<K> {
        final int hash;
        final K key;
        long value;
        Node<K> next;

        Node(int hash, K key, long value, Node<K> next) {
            this.hash = hash;
            this.key = key;
            this.value = value;
            this.next = next;
     ...
     */
    transient Set<Entry<K>> entrySet;
     ...
     */
    public HashMapToLong(int initialCapacity, float loadFactor) {
     ...
     * @throws IllegalArgumentException if the initial capacity is negative.
     */
    public HashMapToLong(int initialCapacity) {
     ...
     */
    public HashMapToLong(MapToLong<? extends K> m) {
     ...
     */
    final void putMapEntries(MapToLong<? extends K> m, boolean evict) {
        int s = m.size();
        if (s > 0) {
    ...
    public long get(K key) {
        Node<K> e;
        return (e = getNode(key)) == null ? Constants.DEFAULT_LONG_VALUE : e.value;
    }
     ...
     */
    final Node<K> getNode(Object key) {
        Node<K>[] tab;
        Node<K> first, e;
        int n, hash;
        K k;
        if ((tab = table) != null && (n = tab.length) > 0 &&
            ...
            if ((e = first.next) != null) {
                if (first instanceof HashMapToLong.TreeNode)
     ...
     */
    final long putVal(int hash, K key, long value, boolean onlyIfAbsent, boolean evict) {
        Node<K>[] tab;
        Node<K> p;
        int n, i;
        if ((tab = table) == null || (n = tab.length) == 0)
        ...
        if ((p = tab[i = (n - 1) & hash]) == null)
            ...
            if (e != null) { // existing mapping for key
                ...
                if (!onlyIfAbsent || oldValue == Constants.DEFAULT_LONG_VALUE)
                    e.value = value;
                afterNodeAccess(e);
                return oldValue;
            }
     ...
     * @throws NullPointerException if the specified map is null
     */
    public void putAll(MapToLong<? extends K> m) {
    ...
    public long remove(K key) {
        Node<K> e;
        return (e = removeNode(hash(key), key, Constants.DEFAULT_LONG_VALUE, false, true)) == null ?
                Constants.DEFAULT_LONG_VALUE : e.value;
    }
     ...
     * @return the node, or null if none
     */
    final Node<K> removeNode(int hash, Object key, long value,
    ...
    final long[] prepareArray(long[] a) {
        int size = this.size;
        if (a.length < size) {
            return (long[]) java.lang.reflect.Array
                    .newInstance(a.getClass().getComponentType(), size);
        }
        if (a.length > size) {
            a[size] = Constants.DEFAULT_LONG_VALUE;
        }
        return a;
    }
    ...
    final class KeySet extends AbstractSet<K> {
        ...
        public final boolean remove(Object key) {
            return removeNode(hash(key), key, Constants.DEFAULT_LONG_VALUE, false, true) != null;
        }

        public final Spliterator<K> spliterator() {
            return new KeySpliterator<>(HashMapToLong.this, 0, -1, 0, 0);
        }
    ...
    final class Values extends AbstractLongCollection {
        ...
        public final Spliterator.OfLong spliterator() {
            return new ValueSpliterator<>(HashMapToLong.this, 0, -1, 0, 0);
        }

        public long[] toArray() {
            return valuesToArray(new long[size]);
        }
    ...
    final class EntrySet extends AbstractSet<Entry<K>> {
        public final int size() {
            return size;
        }
        ...
        public final Spliterator<Entry<K>> spliterator() {
            return new EntrySpliterator<>(HashMapToLong.this, 0, -1, 0, 0);
        }

        public final void forEach(Consumer<? super Entry<K>> action) {
            Node<K>[] tab;
            if (action == null)
                throw new NullPointerException();
            if (size > 0 && (tab = table) != null) {
    ...
    public boolean replace(K key, long oldValue, long newValue) {
        Node<K> e;
        long v;
        if ((e = getNode(key)) != null && e.value == oldValue) {
            e.value = newValue;
            afterNodeAccess(e);
            return true;
        }
    ...
    public long computeIfAbsent(K key,
        ...
        if ((first = tab[i = (n - 1) & hash]) != null) {
            ...
            long oldValue;
            if (old != null && (oldValue = old.value) != Constants.DEFAULT_LONG_VALUE) {
                afterNodeAccess(old);
                return oldValue;
            }
        }
    ...
    public long computeIfPresent(K key,
        ...
        long oldValue;
        if ((e = getNode(key)) != null &&
                (oldValue = e.value) != Constants.DEFAULT_LONG_VALUE) {
            int mc = modCount;
            long v = remappingFunction.applyAsLong(key, oldValue);
            if (mc != modCount) {
                throw new ConcurrentModificationException();
            }
            if (v != Constants.DEFAULT_LONG_VALUE) {
                ...
                int hash = hash(key);
                removeNode(hash, key, Constants.DEFAULT_LONG_VALUE, false, true);
            }
        }
        return Constants.DEFAULT_LONG_VALUE;
    }
    ...
    public long compute(K key,
        ...
        long oldValue = (old == null) ? null : old.value;
        int mc = modCount;
        long v = remappingFunction.applyAsLong(key, oldValue);
        if (mc != modCount) {
            throw new ConcurrentModificationException();
        ...
        if (old != null) {
            if (v != Constants.DEFAULT_LONG_VALUE) {
                ...
                removeNode(hash, key, Constants.DEFAULT_LONG_VALUE, false, true);
        } else if (v != Constants.DEFAULT_LONG_VALUE) {
            if (t != null)
                t.putTreeVal(this, tab, hash, key, v);
            else {
                tab[i] = newNode(hash, key, v, first);
    ...
    public long merge(K key, long value,
        ...
        if (old != null) {
            long v;
            if (old.value != Constants.DEFAULT_LONG_VALUE) {
                int mc = modCount;
                v = remappingFunction.applyAsLong(old.value, value);
                if (mc != modCount) {
                    throw new ConcurrentModificationException();
                }
            } else {
    ...
    @Override
    public void replaceAll(ToLongObjLongBiFunction<? super K>  function) {
        Node<K>[] tab;
        if (function == null)
            throw new NullPointerException();
        if (size > 0 && (tab = table) != null) {
            ...
            for (Node<K> e : tab) {
                for (; e != null; e = e.next) {
                    e.value = function.applyAsLong(e.key, e.value);
                }
            }
            if (modCount != mc)
                throw new ConcurrentModificationException();
    ...
    @Override
    public Object clone() {
        HashMapToLong<K> result;
        try {
            result = (HashMapToLong<K>) super.clone();
    ...
    private void readObject(java.io.ObjectInputStream s)
        ...
        if (mappings < 0)
            ...
            @SuppressWarnings({"rawtypes", "unchecked"})
            Node<K>[] tab = (Node<K>[]) new Node[cap];
            table = tab;
    ...
    abstract class HashIterator {
        Node<K> next;        // next entry to return
        ...
        public final void remove() {
            ...
            if (modCount != expectedModCount)
                throw new ConcurrentModificationException();
            current = null;
            removeNode(p.hash, p.key, Constants.DEFAULT_LONG_VALUE, false, false);
            expectedModCount = modCount;
        }
    }
    ...
    final class EntryIterator extends HashIterator
            implements Iterator<MapToLong.Entry<K>> {
        public final MapToLong.Entry<K> next() {
            return nextNode();
        }
    }
    ...
    static class HashMapSpliterator<K> {
        ...
        HashMapSpliterator(HashMapToLong<K> m, int origin,
                           int fence, int est,
    ...
    static final class KeySpliterator<K>
        ...
        KeySpliterator(HashMapToLong<K> m, int origin, int fence, int est,
                       int expectedModCount) {
    ...
    static final class ValueSpliterator<K>
            extends HashMapSpliterator<K>
            implements Spliterator.OfLong {
        ValueSpliterator(HashMapToLong<K> m, int origin, int fence, int est,
                         int expectedModCount) {
            super(m, origin, fence, est, expectedModCount);
        }
    ...
    static final class EntrySpliterator<K>
            extends HashMapSpliterator<K>
            implements Spliterator<MapToLong.Entry<K>> {
        EntrySpliterator(HashMapToLong<K> m, int origin, int fence, int est,
                         int expectedModCount) {
            super(m, origin, fence, est, expectedModCount);
        }
        ...
        public void forEachRemaining(Consumer<? super MapToLong.Entry<K>> action) {
            int i, hi, mc;
            if (action == null)
                throw new NullPointerException();
            HashMapToLong<K> m = map;
        ...
        public boolean tryAdvance(Consumer<? super MapToLong.Entry<K>> action) {
            int hi;
            if (action == null)
                throw new NullPointerException();
            Node<K>[] tab = map.table;
    ...
    Node<K> newNode(int hash, K key, long value, Node<K> next) {
    ...
    TreeNode<K> newTreeNode(int hash, K key, long value, Node<K> next) {
     ...
     * linked node.
     */
    static final class TreeNode<K> extends LinkedHashMapToLong.Entry<K> {
        ...
        TreeNode(int hash, K key, long val, HashMapToLong.Node<K> next) {
         ...
         */
        static <K> void moveRootToFront(HashMapToLong.Node<K>[] tab, TreeNode<K> root) {
            int n;
         ...
         * this node.
         */
        final Node<K> untreeify(HashMapToLong<K> map) {
         ...
         */
        final TreeNode<K> putTreeVal(HashMapToLong<K> map, Node<K>[] tab,
                                     int h, K k, long v) {
            Class<?> kc = null;
         ...
         */
        final void removeTreeNode(HashMapToLong<K> map, Node<K>[] tab,
                                  boolean movable) {
            int n;
         ...
         */
        final void split(HashMapToLong<K> map, Node<K>[] tab, int index, int bit) {
            TreeNode<K> b = this;
        ...
        static <K, V> TreeNode<K> rotateLeft(TreeNode<K> root,
                                             TreeNode<K> p) {
            TreeNode<K> r, pp, rl;
        ...
        static <K, V> TreeNode<K> rotateRight(TreeNode<K> root,
                                              TreeNode<K> p) {
            TreeNode<K> l, pp, lr;
        ...
        static <K, V> TreeNode<K> balanceInsertion(TreeNode<K> root,
                                                   TreeNode<K> x) {
            x.red = true;
        ...
        static <K, V> TreeNode<K> balanceDeletion(TreeNode<K> root,
                                                  TreeNode<K> x) {
         ...
         */
        static <K, V> boolean checkInvariants(TreeNode<K> t) {
