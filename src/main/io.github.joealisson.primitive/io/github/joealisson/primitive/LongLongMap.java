...
import io.github.joealisson.primitive.function.LongLongBiConsumer;
 ...
 * have no effect on the map.  For example, invoking the {@link #putAll(LongLongMap)}
...
public interface LongLongMap {
     ...
     * of calling {@link #put(long,long) put(k, v)} on this map once
    ...
    interface Entry {
        ...
        static  Comparator<Entry> comparingByValue() {
            return (Comparator<Entry> & Serializable)
                    (c1, c2) -> Long.compare(c1.getValue(), c2.getValue());
        }
     ...
     * @since 2.0
     */
    default void forEach(LongLongBiConsumer action) {
     ...
     * @since 2.0
     */
    default void replaceAll(LongToLongBiFunction function) {
    ...
    static  Entry entry(int k, int v) {
        return new LongKeyLongValue(k, v);
    }
}
